...
MultiMind Browser is a desktop browser for comparing AI assistants and search engines side by side. It supports split-screen cells, a shared input box, and per-cell configuration.

## Install on macOS

Download the `.dmg`, open it, and drag **MultiMind Browser** into **Applications**.
...
2. Right-click **MultiMind Browser** and choose **Open**.
3. In the Gatekeeper dialog, choose **Open** again.
4. If macOS only shows a block message, open **System Settings → Privacy & Security**, find the blocked MultiMind Browser message, and choose **Open Anyway**.

Screenshot guide:

![macOS Gatekeeper Open Anyway flow](docs/images/gatekeeper-open-anyway.svg)
...
4. Launch **MultiMind Browser** from the Start menu or desktop shortcut.

Screenshot guide:

![Windows SmartScreen More info and Run anyway flow](docs/images/smartscreen-run-anyway.svg)
